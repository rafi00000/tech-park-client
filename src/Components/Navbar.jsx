...
const Navbar = () => {
  ...
  const handleThemeChange =() =>{
    ...
    const navLinks = <>
        ...
        <li><NavLink to={'/feedback'}>Add Category</NavLink></li>
        { user && <li><NavLink to={'/give-feedback'}>Give Feedback</NavLink></li> }
    </>;
  ...
  <div>
    ...
    <div className="flex items-center justify-center gap-5">
      <img src="https://i.ibb.co/XC2KxyC/web-logo.png" className="w-20 md:flex" />
  ...
  {/* drop down ends here */}
    ...
    {
      user? <div className="flex flex-col md:flex-row gap-1 rounded-xl items-center border bg-gradient-to-tl from-cyan-500 via-blue-300 to-teal-500 p-2">
