...
const FeedbackForm = () => {
    ...
    return (
        <div className="min-h-screen">
            ...
            <form className="border md:w-1/2 p-5 mx-auto my-5 rounded-md" onSubmit={handleFeedback}>
                ...
                <div className="form-control">
                    <label>message</label>
                    <textarea name="message" className="input input-bordered p-3" cols="30" rows="10"></textarea>
                </div>
                <p className="text-center"><button className="btn btn-outline">Submit</button></p>
            </form>
            <Toaster></Toaster>
        </div>
    );
